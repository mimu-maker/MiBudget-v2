-- Simplified get_hierarchical_categories function that should work
-- Remove complex joins and use basic structure
...
-- Test the function
SELECT '=== TESTING SIMPLIFIED FUNCTION ===' as status;

...
const ExpenseTransactionsTable = ({
    ...
    const handleSaveOverride = (id: string | number, monthKey: string, amount: string) => {
        ...
        // For expenses, we store negative numbers in the DB but absolute values in the UI inputs
                                                                    ...
                                                                    <td className="py-2 px-4 text-right">
                                                                        {isEditing ? (
                                                                            ...
                                                                            <div className="flex items-center justify-end gap-2 group/row">
                                                                                <span>DKK {Math.abs(override?.amount ?? transaction.amount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                                                                                <button

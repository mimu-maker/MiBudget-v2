...
CREATE TABLE IF NOT EXISTS public.user_profiles (
    ...
    onboarding_status TEXT DEFAULT 'not_started' NOT NULL CHECK (onboarding_status IN ('not_started', 'profile_setup', 'preferences_configured', 'categories_added', 'first_transaction', 'completed')),
